      ...
      <ThemedView style={styles.container}>
        ...
        >
          ...
          <ThemedView style={styles.statusContainer}>
            ...
            <ThemedText
              style={[
                styles.statusText,
                passed ? styles.statusSuccess : styles.statusFailure,
              ]}
            >
              ...
              return (
                <ThemedView key={index} style={styles.reviewItem}>
                  <ThemedView style={styles.reviewHeader}>
                    <ThemedText style={styles.reviewQuestionNum}>
                      Question {index + 1}
                    </ThemedText>
                    <ThemedText
                      style={[
        ...
        <ThemedView style={styles.resultsButtons}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <ThemedText style={styles.backHomeButtonText}>
              ← Back to Course
            </ThemedText>
          </TouchableOpacity>
        </ThemedView>
    ...
    >
      <ThemedView style={styles.introContainer}>
        ...
        <ThemedText style={styles.introDescription}>
          Test your knowledge with this interactive quiz. Answer all questions
          to see your results.
        </ThemedText>
